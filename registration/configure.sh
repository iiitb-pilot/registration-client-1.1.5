...
wget "${artifactory_url}/artifactory/libs-release-local/tech5/Tech5-winSdkv1.6_debug.jar" -O "${work_dir}"/registration-client/target/lib/Tech5-winSdkv1.6_debug.jar
